...
import { useDeleteSampleMediaMutation } from '../../api';
...
export function SampleMediaDeletePage(
  ...
  const [deleteSampleMedia, { isError, isSuccess }] =
    ...
    <>
      {deleteStatus === DELETE_STATUS.FAILED && (
        <TransitionsModal
          ...
          description="Try again to delete sample media"
          showButton
