...
export const sampleSlice = createSlice({
  ...
  reducers: {
    ...
    updatedUsedSamplingPlan: (
      state: SampleState,
      { payload: { usedSamplingPlan } },
    ) => {
      state.usedSamplingPlan = usedSamplingPlan;
    },
  },
});
...
export const getSamplingPlan = createSelector(getSampleState, (state) => {
  return state.usedSamplingPlan;
});
